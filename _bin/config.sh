...
SSH_KEY="~/.ssh/wonderland_aws.pem";
PRODUCTION_SERVER="ec2-54-224-133-240.compute-1.amazonaws.com";
PRODUCTION_USER="ubuntu";

GIT_URL="git@github.com:O-clock-Wonderland/the-wonder-plugin.git";
...
PRODUCTION_WORDPRESS_FOLDER="stefan-pk";

WORDPRESS_SITE_NAME="Wonder plugin";
...
PRODUCTION_MYSQL_DATABASE="wdlstefanpk";
...
LOCAL_WORDPRESS_FOLDER="spe-wp/the-wonder-plugin";

LOCAL_MYSQL_USER="explorateur";
LOCAL_MYSQL_PASSWORD="Ereul9Aeng";
LOCAL_MYSQL_HOST="localhost";
LOCAL_MYSQL_DATABASE="wonderplugin";
